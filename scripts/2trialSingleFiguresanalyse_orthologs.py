#!/usr/bin/env python3
"""
Ortholog Analysis Pipeline - Publication Style
Author: Tomi
"""
...
# ── COLORS ────────────────────────────────────────────────────────────────────
NAVY    = '#0d1b2a'   # deep navy for scatter dots
CRIMSON = '#c0392b'
GREEN   = '#27ae60'
GRAY    = '#bdc3c7'
...
for col in predictors:
    ...
    # Deep navy dots
    ax.scatter(x, y, alpha=0.5, s=14, color=NAVY,
    ...
    # Bold tick labels and visible tick marks
...
# ── wider figure + big left margin so labels never overlap bars ───────────────
fig, ax = plt.subplots(figsize=(10, 5))
plt.subplots_adjust(left=0.18)          # extra left space for y-tick labels
...
# Bold y-tick labels with enough padding
